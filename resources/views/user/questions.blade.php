                ...
                <div class="col s9 m9 left">
                    <div class="col s3 m3">
                        <div class="card-panel center">
                            <h4><strong id="total">0</strong></h4>
                            <p class="grey-text darken-4"><strong>TOTAL</strong></p>
                        </div>
                    </div>
                    <div class="col s3 m3">
                        <div class="card-panel center">
                            <h4 class="green-text accent-4"><strong id=correct>0</strong></h4>
                            <p class="grey-text darken-4"><strong>CORRECT</strong></p>
                        </div>
                    </div>
                    <div class="col s3 m3">
                        <div class="card-panel center">
                            <h4 class="red-text lighten-2"><strong id="wrong">0</strong></h4>
                            <p class="grey-text darken-4"><strong>WRONG</strong></p>
                        </div>
                    </div>
                    <div class="col s3 m3">
                        <div class="card-panel center">
                            <h4 class="blue-text lighten-2"><strong id="left">0</strong></h4>
 ...
 <!--    Start End Statictica  -->
                <div class="col s7 m7 offset-m2 total-info">
                    <div class="col s12 m12 chart-view">
                        ...
                        <div class="legend">
                            <div class="item-legend correct" id="correct"></div>
                            <div class="item-legend mistake" id="mistake"></div>
                        </div>
                    </div>
...
$categoryarray.push('{{$categories->category_time}}');


if($categoryarray[0].length==2)
{
  category_time=$categoryarray[0]+":00";
}



$lengthquestionarray=$questionsarray.length;
$left=$lengthquestionarray;
...
$('#total').html($total);
$('#correct').html($correctvariant);
$('#wrong').html($falsevariant);
$('#left').html($left);
...
document.getElementById('correct').innerHTML = "Correct:"+$correctvariant
document.getElementById('mistake').innerHTML = "Mistake:"+$falsevariant
