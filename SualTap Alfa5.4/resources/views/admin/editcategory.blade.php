...
<div class="col s12 m12">
	<form action="/admin/categorymaneger/{{$category->id}}" method="POST">
	<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
		<div class="card">
			<div class="col s5 m5" id="edit-category-input-text">
				<input value="{{$category->category_name}}" type="text" name="question_name">
			</div>
			...
			<div style="margin-left:30px;" class="col s12 m12">
				<textarea name="about_quiz" class="col s5 m5 offset-m1"> {{$category->about_category}}</textarea>
			</div>
			<div class="col s12 m12">
